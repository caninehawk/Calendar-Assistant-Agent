...
* **Live Captions**: The UI features minimal, real-time STT (Speech-To-Text) transcriptions gracefully integrated into the voice visualizer so users can read along visually without the clutter of a full chat interface.
